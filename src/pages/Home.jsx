        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-24">
            ...
            <motion.h2 
              ...
              className="text-5xl font-bold text-gray-900 mb-6 tracking-tight"
            >
              L'excellence au service de votre animal
            </motion.h2>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="text-2xl text-gray-600 max-w-3xl mx-auto font-light"
            >
              Des solutions innovantes pour le bien-être de votre animal
            </motion.p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6, ease: "easeOut" }}
              className="bg-white p-10 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 border border-gray-100 group"
            >
              <div className="bg-nature-50 p-6 rounded-xl mb-8 inline-block transform group-hover:scale-110 transition-transform duration-500">
                <MdHealthAndSafety className="w-10 h-10 text-nature-600" />
              </div>
              <h3 className="text-2xl font-semibold mb-4">Accès 24/7</h3>
            ...
            >
              <div className="bg-nature-50 p-6 rounded-xl mb-8 inline-block transform group-hover:scale-110 transition-transform duration-500">
                <FaUserMd className="w-10 h-10 text-nature-600" />
              </div>
            ...
            >
              <div className="bg-nature-50 p-6 rounded-xl mb-8 inline-block transform group-hover:scale-110 transition-transform duration-500">
                <FaUsers className="w-10 h-10 text-nature-600" />
              </div>
              <h3 className="text-2xl font-semibold mb-4">Communauté active</h3>
              <p className="text-gray-600 text-lg leading-relaxed">
